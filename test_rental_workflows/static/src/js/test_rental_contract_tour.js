odoo.define("rental.contract", function (require) {
    ...
    tour.register(
        ...
        run: function (){} //check Contract: (Analytic Account : [01532] Cat 930M)
                ...
                trigger:
                    '.o_form_view span[name="recurring_next_date"]:contains("04/01/2020")',
                extra_trigger: 'div[name="contract_line_ids"]',
                in_modal: false,
                position: "bottom",
            ...
            {
                content: _t(
                    "Use the breadcrumbs to <b>go back to your Rental Order</b>."
                ),
            ...
            {
                content: _t(
                    "Click on Invoice from list which is created on 04/01/2020"
                ),
                trigger: 'td.o_data_cell:contains("04/01/2020")',
                extra_trigger: ".o_list_view",
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    '.o_invoice_form a[name="contract_type_id"]:contains("Rental Contract")',
                in_modal: false,
                position: "bottom",
