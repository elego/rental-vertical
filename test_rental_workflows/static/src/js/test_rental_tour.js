    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                trigger:
                    "div[name='order_line'] tr.o_data_row td.o_data_cell:contains('[RENT-M-01531] Rental of Volvo L110H (Month(s))')",
                extra_trigger: 'div[name="order_line"]',
                run: "click",
                position: "bottom",
            },
            ...
            },
            {
                content: _t("Click on line to edit"),
                trigger:
                    "div[name='order_line'] tr.o_data_row td.o_data_cell:contains('[RENT-D-01531] Rental of Volvo L110H (Day(s))')",
                extra_trigger: 'div[name="order_line"]',
                run: "click",
                position: "bottom",
            },
            ...
            },
            {
                ...
                trigger:
                    '.o_form_editable td span[name="offday_number"]:contains("0.00")',
            ...
            },
            {
                ...
                run: function () {
                    var inputValue = $(
                        '.o_notebook select[name="fixed_offday_type"] option:last-child'
                    ).val();
            ...
            },
            {
                content: _t("Check Off-Time"),
                trigger:
                    '.o_form_editable td span[name="offday_number"]:contains("17.00")',
                extra_trigger: ".o_notebook",
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                content: _t("Check Off-Time"),
                trigger:
                    '.o_form_editable td span[name="offday_number"]:contains("18.00")',
                extra_trigger: ".o_notebook",
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                run: function () {
                    var inputValue = $(
                        '.o_notebook select[name="fixed_offday_type"] option:nth-last-child(2)'
                    ).val();
                    $('.o_notebook select[name="fixed_offday_type"]').val(inputValue);
                    $('.o_notebook select[name="fixed_offday_type"]').trigger("change");
                },
            },
            {
                ...
                trigger:
                    'div[name="add_offday_ids"] td.o_list_record_remove button[name="delete"]',
                extra_trigger: 'div[name="add_offday_ids"]',
                run: "click",
                position: "bottom",
            },
