odoo.define("rental.quality", function (require) {
    ...
    tour.register(
        ...
        [
            ...
            {
                trigger:
                    "tr.o_selected_row td div.o_field_many2one[name='qualitative_value'] .o_input_dropdown input",
            ...
            {
                trigger:
                    "table tr:nth-child(2) td.o_data_cell:contains('Paint / lettering')",
                extra_trigger: ".o_form_editable",
                run: "click",
            },
            {
                trigger:
                    "table tr:nth-child(2) td div.o_field_many2one[name='qualitative_value'] .o_input_dropdown input",
                extra_trigger: "tr.o_selected_row",
                run: "click",
            },
            {
            ...
            {
                trigger:
                    "table tr:nth-child(3) td.o_data_cell:contains('Scratches / dents')",
                extra_trigger: ".o_form_editable",
                run: "click",
            },
            {
                trigger:
                    "table tr:nth-child(3) td div.o_field_many2one[name='qualitative_value'] .o_input_dropdown input",
                extra_trigger: "tr.o_selected_row",
                run: "click",
            },
            {
            ...
            {
                trigger:
                    "table tr:nth-child(4) td div.o_field_many2one[name='qualitative_value'] .o_input_dropdown input",
                extra_trigger: "tr.o_selected_row",
                run: "click",
            },
            {
            ...
            },
            {
                ...
                trigger: ".o_form_button_save",
                extra_trigger:
                    '.o_statusbar_status .btn-primary:contains("Quality success")',
                position: "bottom",
            },
            {
