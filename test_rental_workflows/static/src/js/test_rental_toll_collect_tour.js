    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                trigger:
                    'button[name="action_view_product_toll_charges"] span[name="toll_line_count"]:contains("11")',
                extra_trigger: 'div[name="order_line"]',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                content: _t("Check Toll Line Charged count"),
                trigger:
                    'button[name="action_view_product_toll_charges"] span[name="toll_line_charged_count"]:contains("11")',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    '.o_data_row:nth-child(2) > .o_data_cell span[name="name"]:contains("Toll Charges for BNA 1534 Total Distance: 44.0 km")',
                extra_trigger: 'div[name="invoice_line_ids"]',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    '.o_data_row:nth-child(2) > .o_data_cell:contains("[01534] Volvo L011H")',
                extra_trigger: 'div[name="invoice_line_ids"]',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    '.o_data_row:nth-child(1) td.o_data_cell:contains("09/15/2020")',
                extra_trigger: ".o_list_view",
                position: "bottom",
            ...
            {
                content: _t(
                    "Update Toll Charges on Invoice after settting value Flase to Chargeable"
                ),
                trigger: 'button[name="action_update_toll_charges"]',
                run: "click",
            },
            ...
            },
            {
                content: _t("Check Toll Line Charged count"),
                trigger:
                    'button[name="action_view_product_toll_charges"] span[name="toll_line_charged_count"]:contains("10")',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                content: _t("Check Description of Toll Charge product on Invoice Line"),
                trigger:
                    '.o_data_row:nth-child(2) > .o_data_cell span[name="name"]:contains("Toll Charges for BNA 1534 Total Distance: 36.8 km")',
                extra_trigger: 'div[name="invoice_line_ids"]',
                in_modal: false,
                position: "bottom",
