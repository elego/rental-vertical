    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                trigger:
                    ".o_form_editable .o_field_many2one[name='partner_id'] .o_input_dropdown input",
                position: "bottom",
                run: "click",
            },
            {
            ...
            },
            {
                ...
                trigger:
                    '.o_form_editable .o_datepicker_input[name="default_start_date"]',
                run: "text 08/01/2020",
                position: "bottom",
            },
            {
                ...
                trigger:
                    '.o_form_editable .o_datepicker_input[name="default_end_date"]',
                run: "text 08/31/2020",
                position: "bottom",
            },
            {
            ...
            {
                trigger:
                    ".o_field_many2one[name='display_product_id'] .o_input_dropdown input",
                run: "click",
            },
            {
            ...
            {
                trigger:
                    ".o_field_many2one[name='product_uom'] .o_input_dropdown input",
                extra_trigger:
                    ".o_field_many2one[name='display_product_id'] .o_external_button",
                run: "click",
            },
            {
            ...
            },
            {
                ...
                extra_trigger:
                    '.o_statusbar_status .btn-primary:contains("Quotation Sent")',
                trigger: 'button[name="action_confirm"]:visible:not(:disabled)',
            },
            {
                content: _t("Check Toll Line count"),
                trigger:
                    'button[name="action_view_product_toll_charges"] span[name="toll_line_count"]:contains("17")',
                extra_trigger: 'div[name="order_line"]',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    'button[name="action_view_product_toll_charges"] span[name="toll_line_charged_count"]:contains("0")',
                extra_trigger: 'div[name="order_line"]',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                extra_trigger:
                    '.o_statusbar_status .btn-primary:contains("Sales Order")',
            },
            {
            ...
            },
            {
                ...
                trigger:
                    '.o_form_view span[name="recurring_next_date"]:contains("08/01/2020")',
                extra_trigger: 'div[name="contract_line_ids"]',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                extra_trigger:
                    'div[name="invoice_count"] span.o_stat_value:contains("1")',
                run: "click",
                position: "bottom",
            },
            {
            ...
            {
                content: _t(
                    "Click on Invoice from list which is created on 08/01/2020"
                ),
                trigger: 'td.o_data_cell:contains("08/01/2020")',
                extra_trigger: ".o_list_view",
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    '.o_invoice_form a[name="sale_type_id"]:contains("Rental Order")',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                content: _t("Check Toll Line Charged count"),
                trigger:
                    'button[name="action_view_product_toll_charges"] span[name="toll_line_charged_count"]:contains("17")',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    '.o_data_row:nth-child(2) > .o_data_cell:contains("Toll Charges")',
                extra_trigger: 'div[name="invoice_line_ids"]',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                ...
                trigger:
                    '.o_data_row:nth-child(2) > .o_data_cell span[name="name"]:contains("Toll Charges for BNA 1535 Total Distance: 262.4 km")',
                extra_trigger: 'div[name="invoice_line_ids"]',
                in_modal: false,
                position: "bottom",
            ...
            {
                content: _t(
                    "Check Analytic Account of Toll Charge Product on Invoice Line"
                ),
                trigger:
                    '.o_data_row:nth-child(2) > .o_data_cell:contains("[01535] Volvo L80H")',
                extra_trigger: 'div[name="invoice_line_ids"]',
                in_modal: false,
                position: "bottom",
            ...
            {
                content: _t(
                    "Check Unit of Measure of Toll Charge Product on Invoice Line"
                ),
            ...
            },
            {
                ...
                trigger:
                    '.o_data_row:nth-child(1) td.o_data_cell:contains("08/28/2020")',
                extra_trigger: ".o_list_view",
                position: "bottom",
            ...
            },
            {
                ...
                run: function () {
                    $('.o_form_sheet div[name="chargeable"] input').attr(
                        "checked",
                        false
                    );
            ...
            },
            {
                content: _t("Check Toll Line Charged count"),
                trigger:
                    'button[name="action_view_product_toll_charges"] span[name="toll_line_charged_count"]:contains("16")',
                in_modal: false,
                position: "bottom",
            ...
            },
            {
                content: _t("Check Description of Toll Charge product on Invoice Line"),
                trigger:
                    '.o_data_row:nth-child(2) > .o_data_cell span[name="name"]:contains("Toll Charges for BNA 1535 Total Distance: 262.2 km")',
                extra_trigger: 'div[name="invoice_line_ids"]',
                in_modal: false,
                position: "bottom",
