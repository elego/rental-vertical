...
class ProductProduct(models.Model):
    ...
    def _default_pricelist(self):
        ...
        # initially first record of pricelist is default pricelist
        return self.env['product.pricelist'].search([], limit=1, order="id asc")
    ...
    def_pricelist_id = fields.Many2one('product.pricelist', 'Default Pricelist', default=_default_pricelist)
