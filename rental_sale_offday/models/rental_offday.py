...
class RentalOffday(models.Model):
    ...
    add_order_line_id = fields.Many2one("sale.order.line", string="Order Line", ondelete="set null")
    fixed_order_line_id = fields.Many2one("sale.order.line", string="Order Line", ondelete="set null")
