...
class SaleOrderLine(models.Model):
    ...
    def onchange_insurance_product_id(self):
        if self.product_id and self.rental and self.product_id.type == 'service' and self.product_id.rented_product_id:
            insurance_products = self.product_id.rented_product_id._get_insurance_product(self.product_uom)
            vals = [(5, 0, 0)]
