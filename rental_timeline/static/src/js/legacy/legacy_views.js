    ...
    class Controller extends Component {
        constructor() {
            ...
            useSetupAction({
                ...
                getGlobalState: () =>
                    getGlobalState(this.controllerRef.comp.exportState()),
                getLocalState: () =>
        ...
        async willStart() {
            ...
            let fieldsInfo = result.fields_views[this.props.type];
            if (Object.hasOwn(result.fields_views, "rental_timeline")) {
                fieldsInfo = result.fields_views["rental_timeline"];
            }
